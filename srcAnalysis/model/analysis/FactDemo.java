...
public class FactDemo {
    ...
    /**
     * @param totalNoOfPeople the totalNoOfPeople to set
     */
    ...
    /**
     * @param totalNoOfSingle the totalNoOfSingle to set
     */
    ...
    /**
     * @param totalNoOfMarried the totalNoOfMarried to set
     */
    ...
    /**
     * @param totalNoOfWidowed the totalNoOfWidowed to set
     */
    ...
    /**
     * @param totalNoOfDivorced the totalNoOfDivorced to set
     */
    ...
    /**
     * @param totalNoOfLiveIn the totalNoOfLiveIn to set
     */
    ...
    /**
     * @param totalNoOfUnknown the totalNoOfUnknown to set
     */
    ...
    /**
     * @return the totalNoOfEdu
     */
    public int getTotalNoOfEdu() {
        return totalNoOfEdu;
    }

    /**
     * @param totalNoOfEdu the totalNoOfEdu to set
     */
    public void setTotalNoOfEdu(int totalNoOfEdu) {
        this.totalNoOfEdu = totalNoOfEdu;
    }

    /**
     * @return the totalNoOfPreSchool
     */
    ...
    /**
     * @param totalNoOfPreSchool the totalNoOfPreSchool to set
     */
    ...
    /**
     * @return the totalNoOf1sTo4thGrade
     */
    public int getTotalNoOf1sTo4thGrade() {
        return totalNoOf1sTo4thGrade;
    }

    /**
     * @param totalNoOf1sTo4thGrade the totalNoOf1sTo4thGrade to set
     */
    public void setTotalNoOf1sTo4thGrade(int totalNoOf1sTo4thGrade) {
        this.totalNoOf1sTo4thGrade = totalNoOf1sTo4thGrade;
    }

    /**
     * @return the totalNoOf5thto6thGrade
     */
    ...
    /**
     * @param totalNoOf5thto6thGrade the totalNoOf5thto6thGrade to set
     */
    ...
    /**
     * @param totalNoOfElemGrad the totalNoOfElemGrad to set
     */
    ...
    /**
     * @return the totalNOOfHSUndergrand
     */
    public int getTotalNOOfHSUndergrand() {
        return totalNOOfHSUndergrand;
    }

    /**
     * @param totalNOOfHSUndergrand the totalNOOfHSUndergrand to set
     */
    public void setTotalNOOfHSUndergrand(int totalNOOfHSUndergrand) {
        this.totalNOOfHSUndergrand = totalNOOfHSUndergrand;
    }

    /**
     * @return the totalNoOfHSGrad
     */
    ...
    /**
     * @param totalNoOfHSGrad the totalNoOfHSGrad to set
     */
    ...
    /**
     * @return the totalNoOfPSUndergrad
     */
    ...
    /**
     * @param totalNoOfPSUndergrad the totalNoOfPSUndergrad to set
     */
    ...
    /**
     * @param totalNoOFPSGrad the totalNoOFPSGrad to set
     */
    ...
    /**
     * @return the totalNoOFColUndergrand
     */
    public int getTotalNoOFColUndergrand() {
        return totalNoOFColUndergrand;
    }

    /**
     * @param totalNoOFColUndergrand the totalNoOFColUndergrand to set
     */
    public void setTotalNoOFColUndergrand(int totalNoOFColUndergrand) {
        this.totalNoOFColUndergrand = totalNoOFColUndergrand;
    }

    /**
     * @return the totalNoOfDegreeHolder
     */
    ...
    /**
     * @param totalNoOfDegreeHolder the totalNoOfDegreeHolder to set
     */
    ...
    /**
     * @param totalNOofBac the totalNOofBac to set
     */
    ...
    /**
     * @param totalNoOfNotStated the totalNoOfNotStated to set
     */
