 ...
 * @author Shermaine
 */
public class SearchReportAnalysis extends BaseServlet {
    ...
    public void servletAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            arrYear = ReportDAO.SearchYearAnylsis(year, sector);
        } catch (ParseException ex) {
            getLogger(SearchReportAnalysis.class.getName()).log(SEVERE, null, ex);
        }
