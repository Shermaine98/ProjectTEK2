...
//    if (page == "byAgeGroupS") {
//        var censusYear = document.getElementById('formIDspecific').value;
//        getDataCensusYear(censusYear);
//    }
    function getDataCensusYear(censusYear) {
...
//        var page = document.getElementById('page').value;
        $.ajax({
            ...
            success: function (data) {
                ...
                var str = '<table  id="dataTable" class="table table-bordered table-hover dat                            </thead>\n\
aTable"> <thead id="thead">\n\
                            </thead>\n\
                            <tbody id="data">\n\
                            </tbody>\n\
                            </table>';
