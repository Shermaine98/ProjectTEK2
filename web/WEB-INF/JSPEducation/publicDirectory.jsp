...
<html>
    <head>
        ...
        <title>Upload Facility | Number of Teachers and Classrooms for Public Schools</title>
        ...
        <script src="jsEducImports/searchSchoolPublic.js" type="text/javascript"></script>
        <!--GEt YEAR-->
                        ...
                        <div style=" margin: 0 auto; display:block; text-align: center;">
                            <div class="form-inline">
                                <div class="form-group" style="background: transparent;">
                                    ...
                                    <button id="viewAll" class="btn btn-default" disabled="disabled" onclick="viewAll()">View All</button>
                                    ...
                                    <form id="submitAll" action="UpdateSchoolDirectory" method="post" class="pull-right">
                                        ...
                                        <input type="hidden" id="classification" name="classification" value="public"/>
                                        <input class="btn btn-primary" id="btnsubmit" type="Submit" value="Submit Public Schools Report" />
                                    </form>
                                </div>
                            </div>
                            ...
                            <table id="approved" class="table table-bordered" role="grid" aria-describedby="incomplete_info">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="totalAllClassroom"><%= directorySchool.get(i).getFormatcount(totalClassroom)%> </td>
                                        <th>Total Seats</th>
                                        <td class="totalAllSeats"><%= directorySchool.get(i).getFormatcount(totalSeats)%></td>
                                    </tr>
