...
<html>
    <head>
        ...
        <title>Upload Facility | Enrollment in Public Elementary Schools</title>
                    ...
                    <div class="row">
                            ...
                            <div class="box box-solid" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form id="UploadFileExcelEnrollment" action="UploadToDatabaseEducation" method="post" enctype="multipart/form-data">
                                        ...
                                        <input  name="classification" id= "classification" type="hidden" value="ePublic" />
                        ...
                        <div class="col-md-12">
                            <div class="box box-solid box-archived">
                                <div class="box-header">
                                    <h3 class="box-title"><b>Pending Reports for Approval:</b> Enrollment in Public Elementary Schools</h3>
                                </div>
                                <form id="archivedView" action="ViewReportsForApprovalEduc" method="post">
                                    <div class="box-body">
                                        ...
                                        <input  name="classification" value="Public" type="hidden" />
                                    </div>
                                </form>
                                <!-- /.box-body -->
                            </div>
