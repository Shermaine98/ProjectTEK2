...
<!--                        <li>
                            <a href="ServletAccess?redirect=homeIT">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu menu-open" style="display:block; background-color: #f9fafc">
                                <li><a href="ServletAccess?redirect=approvalsInternal" style="color: #cc5200; margin-left: 8%;">Internal Accounts</a></li>
                                <li><a href="ServletAccess?redirect=approvalsExternal" style="color: #cc5200; margin-left: 8%;">External Accounts</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu menu-open" style="display:block; background-color: #f9fafc">
                                <li><a href="ServletAccess?redirect=updatesInternal" style="color: #cc5200; margin-left: 8%;">Internal Accounts</a></li>
                                <li><a href="ServletAccess?redirect=updatesExternal" style="color: #cc5200; margin-left: 8%;">External Accounts</a></li>
                            </ul>
                        </li>
                </section>
                <!-- /.sidebar -->
