...
<html>
    <head>
        ...
        <title>Upload Facility | Household Population 10 years old & over by Age group, Sex and Marital Status</title>
            ...
            <div class="content-wrapper">
                ...
                <%}else if (temp.equalsIgnoreCase("UploadError")) { %>
                    <div class="callout callout-danger">
                        ...
                        <p>Kindly upload the correct data for Household Population 10 years old & over by Age Group, Sex and Marital Status</p>
                    </div>
                    <%}%>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="box box-solid" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form id="UploadFileExcel" action="UploadToDatabaseDemo" method="post" enctype="multipart/form-data">
                                        <br>
                                        <label for="file" id="filename" class="custom-file-upload btn btn-block btn-default">
                                            <i class="fa fa-cloud-upload"></i> Upload File
                                        </label>
                                        <input id="file" name="file" type="file" />
                                        <input  name="UploadFile" id= "UplaodFilePage" type="hidden" value="MaritalStatus" />
                        ...
                        <div class="col-md-7">
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    <form id="ErrorPage" action="EditErrorFormServlet" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="box box-solid box-archived">
                                <div class="box-header">
                                    <h3 class="box-title"><b>Pending Reports for Approval:</b> Household Population 10 years old & over by Age group, Sex and Marital Status</h3>
                                </div>
                                <form id="archivedView" action="ViewArchivesReportForApproval" method="post">
                                    <div class="box-body">
                                        ...
                                        <input id="page" name="page" type="hidden"  value="maritalStatus"/>
