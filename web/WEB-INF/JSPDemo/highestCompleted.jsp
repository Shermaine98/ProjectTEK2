...
<html>
    <head>
        ...
        <title>Upload Facility | Household Population 5 years old & over by Highest Grade/Year Completed, Age Group and Sex</title>
                    ...
                    <div class="row">
                            ...
                            <div class="box box-solid" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form id="UploadFileExcel" action="UploadToDatabaseDemo" method="post" enctype="multipart/form-data">
                                        ...
                                        <input  name="UploadFile" id= "UplaodFilePage" type="hidden" value="HHPop.5yrs." />
                        ...
                        <div class="col-md-12">
                            <div class="box box-solid box-archived">
                                <div class="box-header">
                                    <h3 class="box-title"><b>Pending Reports for Approval:</b> Household Population 5 years old & over by Highest Grade/Year Completed, Age Group and Sex</h3>
                                </div>
                                <form id="archivedView" action="ViewArchivesReportForApproval" method="post">
                                    <div class="box-body">
                                        ...
                                        <input id="page" name="page" type="hidden"  value="highestAttaintment"/>
