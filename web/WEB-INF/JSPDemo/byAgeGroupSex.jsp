...
<html>
    <head>
        ...
        <title>Upload Facility | Household Population by Age Group and Sex</title>
            ...
            <div class="content-wrapper">
                ...
                <%} //NOT SUCCESS SAVE IN DB WITH MORE THAN 6 ERRORS
                    ...
                    <div class="callout callout-danger">
                        ...
                        <p>Kindly upload the correct data for Household Population by Age Group and Sex</p>
                    </div>
                    <%}%>
                    ...
                    <div class="row">
                            ...
                            <div class="box box-solid" style="padding-bottom: 5%;">
                                ...
                                <div class="box-body">
                                    <form id="UploadFileExcel" action="UploadToDatabaseDemo" method="post" enctype="multipart/form-data">
                                        ...
                                        <input  name="UploadFile" id= "UplaodFilePage" type="hidden" value="AgeGroup" />
                        ...
                        <div class="col-md-12">
                            <div class="box box-solid box-archived">
                                <div class="box-header">
                                    <h3 class="box-title"><b>Pending Reports for Approval:</b> Household Population by Age Group and Sex</h3>
                                </div>
                                <form id="archivedView" action="ViewArchivesReportForApproval" method="post">
                                    <div class="box-body">
                                        ...
                                        <input id="page" name="page" type="hidden"  value="byAgeGroup"/>
